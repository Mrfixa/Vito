...
class MartMessageScreen extends StatefulWidget {
  final String channelId;
  final String orderId;
  final String userName;

  const MartMessageScreen({
    super.key,
  ...
  @override
  State<MartMessageScreen> createState() => _MartMessageScreenState();
}

class _MartMessageScreenState extends State<MartMessageScreen> {
